...
// ═══════════════════════════════════════════════════════════════════════
// WS2811/NeoPixel Status LED Controller for Master Board
...
public:
  ...
  static constexpr uint32_t COLOR_IDLE       = 0x00FFFF;  // Cyan - Idle/connected
  static constexpr uint32_t COLOR_RUNNING    = 0x00FF00;  // Green - Running/Active
  ...
  static constexpr uint32_t COLOR_WARNING    = 0xFF8000;  // Orange - Warning
